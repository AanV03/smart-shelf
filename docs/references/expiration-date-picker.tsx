      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button
            ...
            variant="outline"
            className={cn(
              "h-10 w-full justify-start border-border/60 bg-secondary/40 text-left font-normal text-foreground hover:bg-secondary/70 hover:text-foreground focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background",
        ...
        <PopoverContent
          className="w-auto border-border/60 bg-card p-0"
          align="start"
        >
          <Calendar
            mode="single"
