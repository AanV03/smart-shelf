...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    environment: {
      ...
      AUTH_DISCORD_ID: env.AUTH_DISCORD_ID ? `✓ ${env.AUTH_DISCORD_ID.substring(0, 10)}...` : "✗ Missing",
      AUTH_DISCORD_SECRET: env.AUTH_DISCORD_SECRET ? "✓ Set" : "✗ Missing",
      AUTH_GOOGLE_ID: env.AUTH_GOOGLE_ID ? `✓ ${env.AUTH_GOOGLE_ID.substring(0, 10)}...` : "✗ Missing",
