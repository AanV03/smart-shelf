...
export function AccountStatusCard({ status, emailVerified, createdAt }: AccountStatusCardProps) {
    return (
        <Card>
            ...
            <CardContent className="space-y-3 sm:space-y-4 px-4 sm:px-6">
                ...
                <div className="flex items-center justify-between gap-2">
                    <span className="text-xs sm:text-sm text-muted-foreground">Email Verificado</span>
