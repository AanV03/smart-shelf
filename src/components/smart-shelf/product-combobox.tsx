...
const products = [
  ...
  { value: "sku-005", label: "Fresh Atlantic Salmon (1lb)", category: "Seafood" },
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          className="h-10 w-full justify-between border-border/60 bg-secondary/40 text-foreground hover:bg-secondary/70 hover:text-foreground focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          {...ariaProps}
        >
          {selectedProduct ? (
      ...
      <PopoverContent className="w-[var(--radix-popover-trigger-width)] border-border/60 bg-card p-0" align="start">
        <Command className="bg-transparent">
          ...
          />
          <CommandList>
            <CommandEmpty className="text-muted-foreground">No product found.</CommandEmpty>
            {["Dairy", "Bakery", "Seafood", "Produce", "Meat", "Pantry", "Beverages"].map(
              (category) => {
